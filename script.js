...
//human win logic
    if (
        (humanChoice === "Rock" && computerChoice === "Kechi") ||
        (humanChoice === "Paper" && computerChoice === "Rock") ||
        (humanChoice === "Kechi" && computerChoice === "Paper")
    ) {
        return "You Win !";
    } if (humanChoice === computerChoice) {
        return "Draw !";
...
//Computer win logic
    if (
        (computerChoice === "Rock" && humanChoice === "Kechi") ||
        (computerChoice === "Paper" && humanChoice === "Rock") ||
        (computerChoice === "Kechi" && humanChoice === "Paper")
    ) {
